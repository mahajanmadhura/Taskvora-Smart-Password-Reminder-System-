                ...
                <div class="card reminder-item mb-3 ${statusClass}" 
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-sm btn-outline-success complete-reminder ${reminder.is_completed ? 'disabled text-success' : ''}" 
                                        data-id="${reminder.id}" ${reminder.is_completed ? 'disabled' : ''}>
